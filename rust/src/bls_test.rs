...
struct MyCircuitInput {
    task_response_digest_g2coords_x_c0: [u64; 4],
    task_response_digest_g2coords_x_c1: [u64; 4],
    task_response_digest_g2coords_y_c0: [u64; 4],
    task_response_digest_g2coords_y_c1: [u64; 4],
    agg_sig_g2coords_x_c0: [u64; 4],
    agg_sig_g2coords_x_c1: [u64; 4],
    agg_sig_g2coords_y_c0: [u64; 4],
    agg_sig_g2coords_y_c1: [u64; 4],
...
struct MyCircuitVirtualInput<F: Field> {
    task_response_digest_g2coords_x_c0: AssignedValue<F>,
    task_response_digest_g2coords_x_c1: AssignedValue<F>,
    task_response_digest_g2coords_y_c0: AssignedValue<F>,
    task_response_digest_g2coords_y_c1: AssignedValue<F>,
    agg_sig_g2coords_x_c0: AssignedValue<F>,
    agg_sig_g2coords_x_c1: AssignedValue<F>,
    agg_sig_g2coords_y_c0: AssignedValue<F>,
    agg_sig_g2coords_y_c1: AssignedValue<F>,
...
impl RawCircuitInput<Fr, MyCircuitVirtualInput<Fr>> for MyCircuitInput {
    fn default() -> Self {
        MyCircuitInput {
            task_response_digest_g2coords_x_c0: [0, 0, 0, 0],
            task_response_digest_g2coords_x_c1: [0, 0, 0, 0],
            task_response_digest_g2coords_y_c0: [0, 0, 0, 0],
            task_response_digest_g2coords_y_c1: [0, 0, 0, 0],
            agg_sig_g2coords_x_c0: [0, 0, 0, 0],
            agg_sig_g2coords_x_c1: [0, 0, 0, 0],
            agg_sig_g2coords_y_c0: [0, 0, 0, 0],
            agg_sig_g2coords_y_c1: [0, 0, 0, 0],
    ...
    fn assign(&self, ctx: &mut Context<Fr>) -> MyCircuitVirtualInput<Fr> {
        let task_response_digest_g2coords_x_c0 = ctx.load_witness(Fr::from_raw(self.task_response_digest_g2coords_x_c0));
        let task_response_digest_g2coords_x_c1 = ctx.load_witness(Fr::from_raw(self.task_response_digest_g2coords_x_c1));
        let task_response_digest_g2coords_y_c0 = ctx.load_witness(Fr::from_raw(self.task_response_digest_g2coords_y_c0));
        let task_response_digest_g2coords_y_c1 = ctx.load_witness(Fr::from_raw(self.task_response_digest_g2coords_y_c1));

        let agg_sig_g2coords_x_c0 = ctx.load_witness(Fr::from_raw(self.agg_sig_g2coords_x_c0));
        let agg_sig_g2coords_x_c1 = ctx.load_witness(Fr::from_raw(self.agg_sig_g2coords_x_c1));
        let agg_sig_g2coords_y_c0 = ctx.load_witness(Fr::from_raw(self.agg_sig_g2coords_y_c0));
        let agg_sig_g2coords_y_c1 = ctx.load_witness(Fr::from_raw(self.agg_sig_g2coords_y_c1));

        MyCircuitVirtualInput {
            task_response_digest_g2coords_x_c0,
            task_response_digest_g2coords_x_c1,
            task_response_digest_g2coords_y_c0,
            task_response_digest_g2coords_y_c1,
            agg_sig_g2coords_x_c0,
            agg_sig_g2coords_x_c1,
            agg_sig_g2coords_y_c0,
            agg_sig_g2coords_y_c1,
